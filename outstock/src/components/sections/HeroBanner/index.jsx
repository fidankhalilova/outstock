    ...
    <div className="relative mb-60 w-full max-h-[900px] mt-15 md:mt-0">
      ...
      >
        ...
        <SwiperSlide>
          <div className="relative">
            <img
              src="https://vela-kazan.myshopify.com/cdn/shop/files/h1-slide2.jpg?v=1691976327"
              alt=""
              className="w-full h-full object-cover relative"
            />
            <div
        ...
        <SwiperSlide>
          <div className="relative">
            <img
              src="https://vela-kazan.myshopify.com/cdn/shop/files/h1-slide3.jpg?v=1691976328"
              alt=""
              className="w-full h-full object-cover relative"
            />
            <div
